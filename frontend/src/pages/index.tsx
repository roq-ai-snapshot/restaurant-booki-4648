  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of dining with Restaurant Booking Engine - a seamless platform for customers to reserve tables and employees to manage reservations and menus."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of dining with Restaurant Booking Engine - a seamless platform for customers to reserve tables and employees to manage reservations and menus.`}
            </Text>
            <Box
